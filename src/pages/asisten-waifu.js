...
import { PopUpAsistenWaifu } from 'src/sections/overview/popup-asistenwaifu';
...
const handleSendClick = async () => {
  try {
    ...
    const take = await auth.obrolangpt(accessToken, selectedCharacter, userInput);

    console.log('Response from obrolangpt:', take);
  ...
  return (
    <>
      ...
      <Box style={boxStyle}>
      <ResponsiveAppBar />
      <PopUpAsistenWaifu open={isModalOpen} onClose={handleCloseModal} />
